...
fig, ax = plt.subplots()
f = open(data_folder+'/'+sys.argv[1].replace("\\",'').replace("/",'')+'_log.txt','w')
for defect_dir in  defect_dirs:
    ...
    incar_para = read_incar(data_folder+'/defect-incar')
...
plt.legend()
plt.savefig(data_folder+'/defect_formation_energy.png',dpi=450)
